...
function(jobName, agentEnv={}, stepEnvFile='', patchFunc=identity) patchFunc({
  ...
  local env = {
    ...
    BUILDKITE_PLUGIN_KUBERNETES_INIT_IMAGE: 'quay.io/muhlba91/buildkite-agent-kubernetes@sha256:42439465e246385da90806e894f8c9532dbb52e79d82a3815846a31c3ad3f4f8',
    ...
    BUILDKITE_PLUGIN_KUBERNETES_JOB_TTL_SECONDS_AFTER_FINISHED: '86400',
